...
0                       IV[0]KEY[0]+KEY[1]KEY[2]+KEY[3]
IV[0](KEY[0])
+KEY[1]KEY[2]+KEY[3]
1                       IV[1]KEY[1]+KEY[2]KEY[3]+KEY[4]
IV[1]KEY[1]
+KEY[2]KEY[3]+KEY[4]
2                       IV[2]KEY[2]+KEY[3]KEY[4]+BIT1
IV[2](KEY[2])
+IV[0](KEY[0])
+KEY[1]KEY[2]+KEY[3]+KEY[3]KEY[4]
3                       IV[3]KEY[3]+KEY[4]BIT1+BIT2
IV[0]KEY[4]KEY[0]
+IV[1]KEY[1]
+IV[3]KEY[3]
+KEY[2]KEY[3]+KEY[4]+KEY[4]KEY[1]KEY[2]+KEY[4]KEY[3]
4                       IV[4]KEY[4]+BIT1BIT2+BIT3
...
5                       IV[1]IV[2]BIT1+BIT2BIT3+BIT4
