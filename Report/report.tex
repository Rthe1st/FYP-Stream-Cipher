...
\caption{Grain-128a, the red feedback lines are only used in initialisation mode. Lines tapping bits from the shift registers represent collections of bits rather then individual ones}
\label{fig:graininit}
}
\end{figure}
\subsection{Specification}
